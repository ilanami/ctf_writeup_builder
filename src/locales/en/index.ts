...
export default {
  ...
  toasts: {
    ...
    pdfExportStarted: "Generating PDF, please wait...",
  },
   pdfModal: {
    ...
    previewHiddenDesc: "Your Write-Up preview will appear in this window.",
  ...
  imageUploader: {
    ...
    optimizing: "Optimizing image... {progress}%",
    optimizingFallback: "Optimizing image...",
  },
  tagInput: {
    addButton: "Add",
